    ...
    <div class="container mx-auto px-4 py-8">
        ...
        @if ($viewMode === 'admin')
            ...
            <form action="{{ route('components.update', $component->id) }}" method="POST" enctype="multipart/form-data"
                  class="bg-white p-8 rounded-lg shadow-md space-y-6 max-w-4xl mx-auto">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="file" name="image" id="image"
                           class="block w-full text-sm bg-gray-50 border border-gray-300 rounded p-2">
                </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="characteristics"
                                  class="w-full p-2 border rounded bg-gray-50 h-40 resize-none">{{ str_replace(';', ";\n", $component->characteristics) }}</textarea>
                    </div>

                    <div>
                        <label class="font-semibold block mb-1">Совместимость (JSON)</label>
                        <textarea name="compatibility_data"
                                  class="w-full p-2 border rounded bg-gray-50 h-32 resize-none">{{ $component->compatibility_data }}</textarea>
        ...
        @else
            ...
            <div class="max-w-5xl mx-auto mt-4 bg-white rounded-2xl shadow-xl p-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4 text-gray-800">
                        ...
                        <div><span class="font-medium">Категория:</span> {{ $component->category->name }}</div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="whitespace-pre-line text-sm bg-gray-50 p-4 rounded border">
